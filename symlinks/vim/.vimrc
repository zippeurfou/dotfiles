...
"Plug 'jpo/vim-railscasts-theme'"do not work like that :/
"tmux nav
...
" surround character,i.e. cs"'
Plug 'tpope/vim-surround'
"highlight for stan
Plug 'maverickg/stan.vim'
" Comment with gcc and gcu
Plug 'tpope/vim-commentary'
"TODO add new file types autocmd FileType apache setlocal commentstring=#\ %s
" Add repeat pluging that allow to repeat plug action with .
Plug 'tpope/vim-repeat'
"ctag made automatic
Plug 'ludovicchabant/vim-gutentags'
" completion
Plug 'ajh17/VimCompletesMe'
" edit history tree use :UndotreeToggle
Plug 'mbbill/undotree'
" vim sneak allow some cleaver jump
Plug 'justinmk/vim-sneak'
" target allow cool motion
Plug 'wellle/targets.vim'
" tagbar :TagbarToggle
Plug 'majutsushi/tagbar'
" trying fzf as it should be faster..
...
" Plug 'jistr/vim-nerdtree-tabs' " can't make it work.. https://github.com/jistr/vim-nerdtree-tabs/issues/76
" html emmet
...
"Add word motion for camel case
...
" markdown preview with ctrl+P
Plug 'JamshedVesuna/vim-markdown-preview'
" List ends here. Plugins become visible to Vim after this call.
call plug#end()
"ignore files in NERDTree
let NERDTreeIgnore=['\.pyc$','\.Rd$','\.o$', '\~$']
" stupid bug fix from https://github.com/jistr/vim-nerdtree-tabs/issues/84
" let g:nerdtree_tabs_synchronize_view = 0 " not working nvm..
" javascript plug option
...
" gitgutter update rate to 250ms
set updatetime=250
"change the camelcase word motion to leader
let g:wordmotion_prefix = '<Leader>'
"Add mapping for tmux <ctrl-h> => Left
"<ctrl-j> => Down
"<ctrl-k> => Up
"<ctrl-l> => Right
"<ctrl-\> => Previous split
" key binding for vimux
" Write all buffers before navigating from Vim to tmux pane
"let g:tmux_navigator_save_on_switch = 2

" Run the current file with rspec
" map <Leader>rb :call VimuxRunCommand("clear; rspec " . bufname("%"))<CR>
" map <Leader>r :call VimuxRunCommand(bufname("%"))<CR>
...
" TODO ignore tags Rd, o and other formats
command! -bang -nargs=* Find call fzf#vim#grep('rg --column --line-number --no-heading --fixed-strings --ignore-case --no-ignore --hidden --follow --glob \!.git/* --color "always" '.shellescape(<q-args>).'| tr -d "\017"', 1, <bang>0)
" let g:airline_section_b+='{gutentags#statusline()}'
" let g:airline_section_y='%{gutentags#statusline("[Generating...]")}'
set tags=./.tags,.tags;
...
" vim-markdown-preview github preview
...
" let g:sneak#label = 1
" replacing s with Z so motion and finding at the same
map <Leader>z <Plug>Sneak_s
map <Leader>Z <Plug>Sneak_S

" Add the right pytest for shims
